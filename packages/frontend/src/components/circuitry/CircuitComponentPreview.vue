...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto overflow-visible" :style="{
        ...
        <circle v-for="(port, i) in metadata.getDefaultPorts()" :key="i" :cx="port.x * GRID_SIZE"
            :cy="port.y * GRID_SIZE" r="2" fill="currentColor" class="rounded-full text-orange-500" />
    </svg>
</template>
