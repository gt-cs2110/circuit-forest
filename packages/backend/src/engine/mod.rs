...
pub use repr::*;
pub use func::{Component, ComponentFn, PortProperties};
pub use graph::{CircuitGraph, FunctionKey, ValueKey, FunctionPort};
...
mod tests {
    ...
    fn splitter() {
        ...
        let cfg = func::SplitterConfig::new(func::splitter_ports_range(8), 8, 8).unwrap();
